        ...
        <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? 'py-2' : 'py-4'}`}>
          <div className="container mx-auto px-6">
            <div className={`mx-auto max-w-6xl px-6 py-3 rounded-2xl flex items-center justify-between transition-all duration-500 ${
              ...
              >
                <img src="/logo.png" alt="OkeBill - Automated GST Billing" className="w-9 h-9 rounded-xl shadow-md shadow-emerald-200 group-hover:shadow-lg group-hover:shadow-emerald-300 transition-shadow" />
              ...
              {/* Mobile Toggle */}
              <button className="md:hidden text-zinc-600" aria-label="Toggle Menu" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-zinc-900">{f.title}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto items-stretch">
              {plans.map((plan, i) => (
                ...
                >
                  ...
                  <h3 className={`text-lg font-semibold mb-2 ${plan.highlighted ? 'text-white' : 'text-zinc-900'}`}>
                    {plan.name}
                  </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16 max-w-5xl mx-auto">
            <div className="col-span-2 lg:col-span-2 pr-8">
              <div className="flex items-center gap-2.5 mb-6">
                <img src="/logo.png" alt="OkeBill Logo" className="w-8 h-8 rounded-lg" />
